...
export default function SocialMedia() {
  return(
    <>
      <div id="footer" className="footer-social-links container fixed">
        <a href="https://www.linkedin.com/in/law-tam/" title="LinkedIn" target="_blank" rel="noreferrer"><i className="fa fa-linkedin"></i></a>
        <a href="https://medium.com/@lawhtam" title="Medium" target="_blank" rel="noreferrer"><i className="fa fa-medium"></i></a>
